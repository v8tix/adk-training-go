...
This gives you two run modes for free, confirmed by running both this session:
...
* **`go run ./cmd/echo-agent console`** — a no-browser CLI chat mode, nice whenever you don't want a browser open at all. 💻
