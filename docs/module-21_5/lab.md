# Lab 21.5: MAS Architecture Design Challenge (Go)

## Goal

No code this lab. You'll act as a Lead AI Architect: given three business scenarios, pick the right pattern from modules 16-21, sketch the graph geometry, and justify the choice.
...
This is a **hybrid** of two patterns already built in this repo:
